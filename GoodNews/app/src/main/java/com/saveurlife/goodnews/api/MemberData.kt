...
data class MemberInfo(val memberId:String, val phoneNumber:String, val name:String, val birthDate: String, val gender: String, val bloodType: String, val addInfo: String, val state:String, val lat:Double, val lon:Double, val familyId: Int)
