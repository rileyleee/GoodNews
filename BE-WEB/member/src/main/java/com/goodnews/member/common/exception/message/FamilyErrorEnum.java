...
public enum FamilyErrorEnum {
    INVALID_FAMILY_MEMBER(3002,"가족이 존재하지 않습니다. memberId: "),
    ...
    INVALID_FAMILY_PLACE_SIZE(3004,"가족 모임 장소 개수는 최대 3개입니다 memberId: "),
    INVALID_FAMILY_REQUEST(3005, "이미 등록된 가족입니다.");
